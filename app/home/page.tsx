...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen ">
      ...
      {/* Hero Section */}
      {/* <section className="bg-darkblue text-black ">
    ...
    <div className="flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-10 md:mb-0">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-8">
          Predict your risk of heart disease with our advanced machine learning model. Get accurate insights based on your health data.
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
      ...
      <div className="md:w-1/2 flex justify-center">
        <div className="relative w-64 h-64 md:w-80 md:h-80">
          <Heart className="w-full h-full text-darkblue/10" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild size="lg" className="bg-black hover:bg-opacity-90">
